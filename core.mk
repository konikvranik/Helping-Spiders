...
FLAGSSUFFIX=-DF_CPU=80000000L -DLWIP_OPEN_SRC -DARDUINO=10608 -DARDUINO_$(BOARD) -DARDUINO_ARCH_$(PLATFORM) -DARDUINO_BOARD=\"$(BOARD)\" -D$(PLATFORM) ${FLAGS} -include $(CORE_PATH)/src/config.h
...
clean:
	-$(RMDIR) $(BUILDDIR)/../RGBLEDBlender $(BUILDDIR)/../multisensor $(BUILDDIR) $(dir $(MODULE))
